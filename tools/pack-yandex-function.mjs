...
async function main() {
    ...
    const includeRoots = ['index.js', 'package.json', 'package-lock.json', 'lib', 'data', 'node_modules']
        .map((p) => join(fnDir, p))
    ...
    await new Promise((resolve, reject) => {
        ...
        for (const full of files) {
            ...
            // PDF (~сотни MB) не в ZIP функции — лимит пакета; хранить в Object Storage / assets
            if (rel.startsWith('data/instructions/pdf/')) continue;
