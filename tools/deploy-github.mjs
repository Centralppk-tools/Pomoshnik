...
function shouldSkip(relPath) {
    ...
    // Базы и чанки — только на Yandex Cloud Function, не на GitHub Pages
    const serverOnly = new Set([
        ...
        'data/line-sections.md',
        'data/instructions/catalog.json',
        'data/instructions/index.json',
    ]);
    if (serverOnly.has(normalized)) return true;
    if (normalized.startsWith('data/instructions/chunks/')) return true;
    return false;
}
